...
######生成特征向量#############
featuer = pd.read_csv(r'../../../Data/SM2miR_exp/feature/feature_GATNE_line_down-regulate_128.csv', sep=',', header=None).values.tolist()
...
for i in range(1,6,1):
    ...
    train_set = pd.read_csv(r'../../../Data/SM2miR_exp/5-fold/Fold'+str(i)+' downregulate train.csv',header=0)
    test_set = pd.read_csv(r'../../../Data/SM2miR_exp/5-fold/Fold'+str(i)+' downregulate test.csv',header=0)
