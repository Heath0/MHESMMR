...
while counter0 < 6:
    ...
    RAPName = 'y_test_Pre' + str(counter0) + '.csv'
    RAPNameProb = 'y_test_Prob' + str(counter0) + '.csv'
...
storFile(MyNew, '5-fold evaluation.csv')
print(MyNew)
...
# 画对角线
x = np.arange(0,2)
plt.plot(x,x, color='black', lw=2, linestyle='--')
plt.legend(bbox_to_anchor=(1, 0.45),fontsize=11)
